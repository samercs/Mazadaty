...
namespace Mazadaty.Web.Areas.admin.Models.Auctions
{
    public class AddEditViewModel
    {
        public IEnumerable<SelectListItem> ProductList { get; set; }
        public Mazadaty.Models.Auction Auction { get; set; }
        ...
        public async Task<AddEditViewModel> Hydrate(ProductService productService, Product product)
        {
            ...
            Auction = new Mazadaty.Models.Auction
            {
        ...
        public async Task<AddEditViewModel> Hydrate(ProductService productService, Mazadaty.Models.Auction auction)
        {
            Auction = auction;
